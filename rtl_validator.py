...
# The following RTL has hardware-critical issues detected by a linter:
...
#     # Step 2: Linter
#     lint_output = run_linter(code)
#     issues = detect_lint_errors(lint_output)
...
#         "lint_issues": issues,
#         "is_clean": compile_ok and len(issues) == 0
#     }


# # ==============================
# # 7. Backward Compatibility (OLD FUNCTION)
# # ==============================
...
#             return "⚠️ Compiled but has LINT issues:\n" + "\n".join(result["lint_issues"])
